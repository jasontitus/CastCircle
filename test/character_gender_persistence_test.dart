...
void main() {
  ...
  test('an explicit choice beats inference', () {
    final script = buildParsedScript(
      'Play',
      linesFor(['KING', 'OPHELIA']),
  ...
  test('inference still applies where nothing was set', () {
    ...
    expect(
      script.characters.firstWhere((c) => c.name == 'KING').gender,
      CharacterGender.male,
    );
    expect(
      script.characters.firstWhere((c) => c.name == 'QUEEN').gender,
