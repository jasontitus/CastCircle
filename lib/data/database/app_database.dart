...
class AppDatabase extends _$AppDatabase {
  ...
  Future<List<Production>> getAllProductions() => select(productions).get();

  Stream<List<Production>> watchAllProductions() => select(productions).watch();

  Future<Production?> getProduction(String id) =>
      (select(productions)..where((p) => p.id.equals(id))).getSingleOrNull();
